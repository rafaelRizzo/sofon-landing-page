      ...
      <main className="flex items-center justify-center text-center h-[600px] p-10">
        <Container>
          <div className="relative">
            ...
            <Button className="my-2 bg-violet-700 hover:bg-violet-600 dark:text-zinc-100 hover:scale-105 transition">Quero o melhor atendimento para seus clientes</Button>
      ...
      <section className="px-10 mb-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            <Card className="p-5">
              <CardContent>
                <CardTitle className="text-center text-2xl my-2">Servidor PABX</CardTitle>
              </CardContent>
            </Card>
            <div>
              <Card className="overflow-hidden scale-105 border-violet-500 dark:border-violet-700 bg-violet-50/30 dark:bg-transparent">
                <h1 className="p-2 text-center text-zinc-100 bg-violet-500 dark:bg-violet-700">MAIS BUSCADO</h1>
            ...
            <Card className="p-5">
              <CardContent>
                <CardTitle className="text-center text-2xl my-2">Número VOIP</CardTitle>
              </CardContent>
            </Card>
          </div>
